...
@include('frontend.Default.partials.messages')
  ...
  <div class="login"style="background-image: url('/frontend/Default/img/_src/redirected-bg.png')">
	...
	<br><br>
 Please make sure you verify your email address after you register! so you can log in!
    <div class="login__block">
      <div class="login__left">

        <form class="login-form" action="<?= route('frontend.register.post') ?>" id="register-form" method="POST">
          <input type="hidden" value="<?= csrf_token() ?>" name="_token">
          <div class="input__group">            <input type="text" id="username" name="username" placeholder="@lang('app.username')" class="loginInput">
          </div>
